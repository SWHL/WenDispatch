export declare const AGENT_NATIVE_HOST_NAME = "org.wendispatch.bridge";
export declare const AGENT_HTTP_HOST = "127.0.0.1";
export declare const AGENT_HTTP_PORT = 39123;
export declare const AGENT_RPC_ACTIONS: readonly ["health", "list_platforms", "list_accounts", "create_post", "update_post", "publish_post", "get_job_status", "cancel_job", "render_wechat_html"];
export type AgentRpcAction = (typeof AGENT_RPC_ACTIONS)[number];
export declare const AGENT_ERROR_CODES: readonly ["extension_unavailable", "default_account_not_configured", "post_not_found", "job_not_found", "unsupported_platform", "validation_error", "internal_error"];
...
export type AgentJobState = 'pending' | 'running' | 'done' | 'failed' | 'pending_manual_confirm';
