...
describe('MDH Core Renderer', () => {
  describe('renderMarkdownToHtml', () => {
    ...
    it('should render links nested in list item text', () => {
      const result = renderMarkdownToHtml(
        '- Source: [source](https://github.com/example/commit)\n' +
      ...
      expect(result.html).not.toContain('[source](https://github.com/example/commit)');
      expect(result.html).not.toContain('[#729](https://github.com/example/issues/729)');
    });
