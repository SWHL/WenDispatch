...
This phase keeps the current WenDispatch UI and persistence model. It improves the existing foreground AI rewrite workflow without adding a background queue or a new page.
