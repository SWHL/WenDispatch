...
Improve the current AI rewrite output quality by strengthening "rewrite + remove AI flavor" while keeping the feature lightweight, isolated, and close to the existing WenDispatch architecture.
