  ...
  <div class="w-96 min-h-120 bg-[#f5f6f7] relative overflow-hidden">
          ...
          <div v-else class="max-h-64 overflow-y-auto custom-scrollbar space-y-2 pr-1">
            ...
            >
              <div class="flex items-start gap-3">
                <div class="w-10 h-10 rounded-lg bg-[#e7f3ee] flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
    ...
    >
      ...
      >
        ...
        >
          <AppIcon :name="toast.type === 'success' ? 'check' : 'error'" class="text-lg" />
