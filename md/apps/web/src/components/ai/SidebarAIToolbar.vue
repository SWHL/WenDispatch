...
<template>
  ...
  >
    ...
    <div
      v-if="!isExpanded"
      class="w-5 h-16 bg-[#e7f3ee] hover:bg-[#d8ebdf] dark:bg-[#344047] dark:hover:bg-[#3f5058] cursor-pointer transition-colors duration-200 flex items-center justify-center rounded-l-lg group utools-sidebar-edge"
    ...
    >
      ...
      <Transition name="hint-fade">
        <div
          ...
          class="hint-bubble absolute right-full mr-3 px-4 py-2 bg-[#344047] text-white text-sm font-medium rounded-lg shadow-sm whitespace-nowrap pointer-events-none animate-bounce-gentle z-50"
    ...
    >
      ...
      <div class="flex flex-col py-2 gap-2">
        ...
        <div class="flex flex-col items-center gap-1 px-1">
          <button
            class="group relative w-7 h-7 rounded-lg bg-[#5d8fa8] hover:bg-[#4f7c92] text-white shadow-sm hover:shadow-md transition-shadow duration-200 flex items-center justify-center utools-ai-button"
            title="AI助手"
            @click="openAIChat"
          >
            <Bot class="h-4 w-4" />
        ...
        <div class="flex flex-col items-center gap-1 px-1">
          <button
            class="group relative w-7 h-7 rounded-lg bg-[#8c7aa8] hover:bg-[#786894] text-white shadow-sm hover:shadow-md transition-shadow duration-200 flex items-center justify-center utools-ai-button"
            title="AI文生图"
        ...
        <div v-if="hasSelectedText && isExpanded" class="flex flex-col items-center gap-1 px-1">
          <button
            class="group relative w-7 h-7 rounded-lg bg-[#2e9b68] hover:bg-[#277f56] text-white shadow-sm hover:shadow-md transition-shadow duration-200 flex items-center justify-center utools-ai-button"
            title="AI工具箱"
            @click="openAIToolBox"
          >
            <Wand2 class="h-4 w-4" />
