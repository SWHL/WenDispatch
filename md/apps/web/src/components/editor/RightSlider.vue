...
<template>
  ...
  >
    ...
    >
      ...
      <div class="space-y-2">
        <h2>主题</h2>
        <Select v-model="theme" @update:model-value="themeChanged">
          <SelectTrigger class="w-full">
            <SelectValue placeholder="选择排版主题" />
          </SelectTrigger>
          <SelectContent class="max-h-72">
            <SelectItem v-for="{ label, value, desc } in themeOptions" :key="value" :value="value">
              <span>{{ label }}</span>
