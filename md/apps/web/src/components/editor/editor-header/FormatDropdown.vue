...
<template>
  ...
  <MenubarSub v-if="asSub">
    <MenubarSubTrigger :class="{ 'p-2': iconOnly }" :title="iconOnly ? '格式' : undefined" :aria-label="iconOnly ? '格式' : undefined">
      <Type v-if="iconOnly" class="size-4" />
      <span v-else>格式</span>
    </MenubarSubTrigger>
  ...
  <MenubarMenu v-else>
    <MenubarTrigger
      :class="{ 'p-2': iconOnly }"
      :aria-label="iconOnly ? '格式' : undefined"
      :title="iconOnly ? '格式' : undefined"
    >
      <Type v-if="iconOnly" class="size-4" />
      <span v-else>格式</span>
    </MenubarTrigger>
