...
<template>
  ...
  <MenubarSub v-if="asSub">
    <MenubarSubTrigger :class="{ 'p-2': iconOnly }" :title="iconOnly ? '文件' : undefined" :aria-label="iconOnly ? '文件' : undefined">
      <FileText v-if="iconOnly" class="size-4" />
      <span v-else>文件</span>
    </MenubarSubTrigger>
  ...
  <MenubarMenu v-else>
    <MenubarTrigger
      :class="{ 'p-2': iconOnly }"
      :aria-label="iconOnly ? '文件' : undefined"
      :title="iconOnly ? '文件' : undefined"
    >
      <FileText v-if="iconOnly" class="size-4" />
      <span v-else>文件</span>
    </MenubarTrigger>
