...
<template>
  ...
  <MenubarSub v-if="asSub">
    <MenubarSubTrigger :class="{ 'p-2': iconOnly }" :title="iconOnly ? '编辑' : undefined" :aria-label="iconOnly ? '编辑' : undefined">
      <Pencil v-if="iconOnly" class="size-4" />
      <span v-else>编辑</span>
    </MenubarSubTrigger>
  ...
  <MenubarMenu v-else>
    <MenubarTrigger
      :class="{ 'p-2': iconOnly }"
      :aria-label="iconOnly ? '编辑' : undefined"
      :title="iconOnly ? '编辑' : undefined"
    >
      <Pencil v-if="iconOnly" class="size-4" />
      <span v-else>编辑</span>
    </MenubarTrigger>
